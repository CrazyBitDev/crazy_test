...
def parse_args():
    ...
    # Wandb
    parser.add_argument("--wandb_project_name", type=str, default="ROBXAI_Exam", help="Wandb's project name")
    parser.add_argument("--wandb_entity", type=str, default="matteoingusci01", help="Entity of wandb's project")    
    ...
    # Episode length
    parser.add_argument("--n_episode", type=int, default=2000, help="Experiment total timesteps") # 4000
    ...
    parser.add_argument("--eps_decay", type=float, default=0.995, help="ε-greedy decay value")
    parser.add_argument("--tau", type=float, default=0.005, help="Polyak averaging factor")

    # Buffer
    parser.add_argument("--memory_size", type=int, default=20000, help="Size of the memory buffer")
    ...
    parser.add_argument("--layer_size", type=int, default=64, help="Number nodes for each layer")
    parser.add_argument("--activation", type=str, default='relu', help="Activation function")

    # Update
    parser.add_argument("--n_epochs", type=int, default=10, help="Number of epochs for policy update")
